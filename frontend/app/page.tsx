...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-muted/50 text-foreground font-sans selection:bg-blue-100 relative overflow-hidden flex flex-col">
      ...
      <header className="container mx-auto px-6 py-6 flex items-center justify-between relative z-10 w-full max-w-7xl">
        <div className="flex items-center gap-3">
          ...
          <span className="text-2xl font-bold tracking-tight text-card-foreground">Ziva Care</span>
        </div>
      ...
      <section className="container mx-auto px-6 pt-24 pb-20 relative z-10 flex flex-col items-center justify-center max-w-7xl">
        ...
        <motion.h1
          className="text-5xl md:text-7xl font-extrabold tracking-tight text-foreground mb-8 max-w-4xl text-center leading-[1.1]"
        ...
        >
          ...
          <Link href="/login" className="w-full sm:w-auto px-8 py-4 bg-card text-slate-700 border border-border rounded-full font-semibold shadow-sm hover:bg-muted/50 hover:-translate-y-1 transition-all flex items-center justify-center gap-2 text-base">
            Sign In to Portal
          </Link>
        </motion.div>
      </section>
      ...
      {/* ─── Stats Strip ─────────────────────────────────────── */}
      <section className="relative z-10 bg-card border-y border-slate-100">
      ...
      <section id="features" className="relative z-10 container mx-auto max-w-7xl px-6 py-28">
        <Reveal className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mt-3">Powerful Features for Better Care</h2>
          <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-lg">A comprehensive suite of tools designed to simplify every aspect of clinic operations and patient experience.</p>
        </Reveal>
          ...
          {[
            ...
            return (
              <Reveal key={feat.title} delay={i * 0.08}>
                <div className="bg-card p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow group h-full">
      ...
      {/* ─── How It Works ────────────────────────────────────── */}
      <section id="how-it-works" className="relative z-10 bg-card py-28">
        <div className="container mx-auto max-w-6xl px-6">
          <Reveal className="text-center mb-20">
            <span className="text-sm font-semibold text-blue-600 uppercase tracking-wider">Simple Process</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-foreground mt-3">Get Started in 3 Easy Steps</h2>
          </Reveal>
      ...
      {/* ─── Why Choose Us ───────────────────────────────────── */}
      <section className="relative z-10 bg-card py-28">
        <div className="container mx-auto max-w-6xl px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <Reveal>
              <div>
                <span className="text-sm font-semibold text-blue-600 uppercase tracking-wider">Why Ziva Care</span>
                <h2 className="text-3xl md:text-4xl font-extrabold text-foreground mt-3 mb-6">Healthcare, Simplified for Everyone</h2>
            ...
            <Reveal delay={0.2}>
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-10 text-white shadow-2xl shadow-blue-600/20">
                ...
                <Link href="/register" className="inline-flex items-center gap-2 bg-card text-blue-700 font-semibold px-7 py-3.5 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all group">
                  Create Free Account
                  <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
        ...
        <div className="container mx-auto max-w-6xl px-6 py-20">
          <Reveal>
            <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-3xl px-10 py-16 md:px-20 text-center text-white shadow-2xl shadow-blue-600/25 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-60 h-60 bg-card/5 rounded-full -translate-y-1/2 translate-x-1/4" />
              <div className="absolute bottom-0 left-0 w-40 h-40 bg-card/5 rounded-full translate-y-1/2 -translate-x-1/4" />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative">
                <Link href="/register" className="px-8 py-4 bg-card text-blue-700 rounded-full font-semibold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all flex items-center gap-2 group">
                  Get Started — It&apos;s Free
                  <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link href="/login" className="px-8 py-4 bg-card/10 text-white border border-white/20 rounded-full font-semibold hover:bg-card/20 transition-all backdrop-blur-sm">
                  Sign In Instead
                </Link>
              </div>
            </div>
      ...
      {/* ─── Footer ──────────────────────────────────────────── */}
      <footer id="contact" className="relative z-10 bg-slate-900 text-muted-foreground pt-20 pb-10">
